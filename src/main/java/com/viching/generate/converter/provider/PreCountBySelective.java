...
@Component
public class PreCountBySelective extends GenerateProvider {

	public PreCountBySelective() {
		super();
	}
	...
	public void addClassElements(TopLevelClass topLevelClass, DBTableJavaBean dbTable) {
		...
		Method method = new Method(GenerateMethod.METHOD_COUNT_SELECTIVE);
		...
		method.addBodyLine(String.format("%sSELECT(\"count(*)\");", builderPrefix));
