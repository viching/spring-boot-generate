...
@Component
public class PreUpdateBatch extends GenerateProvider {

	public PreUpdateBatch() {
		super();
	}
	...
	public void addClassElements(TopLevelClass topLevelClass,
        ...
        Method method = new Method(GenerateMethod.METHOD_UPDATE_BATCH);
	...
	private void addOne(Method method, DBTableJavaBean dbTable) {
