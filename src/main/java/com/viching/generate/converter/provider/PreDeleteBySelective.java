...
@Component
public class PreDeleteBySelective extends GenerateProvider {

	public PreDeleteBySelective() {
		super();
	}
	...
	public void addClassElements(TopLevelClass topLevelClass, DBTableJavaBean dbTable) {
		...
		Method method = new Method(GenerateMethod.METHOD_DELETE_SELECTIVE);
		...
		method.addBodyLine(String.format("%sDELETE_FROM(\"%s\");", 
