...
@Component
@InjectionOrder(12)
public class GenerateSelectBySelective extends GenerateMethod {
	...
	public void addInterfaceElements(Interface interfaze,
		...
		FullyQualifiedJavaType returnType = FullyQualifiedJavaType
				.getNewListInstance();
		returnType.addTypeArgument(new FullyQualifiedJavaType(dbTable
				.getBaseRecordType()));
		method.setReturnType(returnType);

		method.setName(METHOD_SELECT_SELECTIVE);
	...
	public void addMapperAnnotations(Method method, DBTableJavaBean dbTable) {
		...
		sb.append(METHOD_SELECT_SELECTIVE);
		sb.append("\")");
